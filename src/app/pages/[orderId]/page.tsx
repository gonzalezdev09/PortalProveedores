...
import { OrderDetail, OrderStatus, OrderType, InvoicePaymentStatus, PartQuality, RepairSubStatus, OperationCode, wor } from '../../types'; // Ajusta la ruta si types.ts está en otro lugar
